...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  // For Expo Go, Google OAuth has limitations due to redirect URI requirements
  // The redirect URI generated by Expo Go is not accepted by Google
  ...
  // Configure Google AuthRequest hook
  // Note: Google OAuth may not work in Expo Go due to redirect URI limitations
  // Use a Development Build for full OAuth functionality
